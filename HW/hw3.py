...
lso_reduce = functools.reduce(lambda x,y: x+y, lst_to_sort)
print(lst_to_reduce)
# 25. Use filter and lambda to filter the number of a lst_to_sort with elem % 2 == 1.
# lst_to_filter = list(filter(lambda x: x % 2 == 1, lst_to_sort))
# print(lst_to_filter)
# 26. Considering the range of values: b = range(-10, 10), use the function filter to return only negative numbers.
# lst_to_filter_negative = list(filter(lambda x: x < 0, range(-10, 10)))
# print(lst_to_filter_negative)
